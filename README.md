...
- **Админка**: регистрация/логин, список квизов, редактор (вопросы, бриф для ИИ, настройки, публикация), embed-коды, прямая ссылка `/q/:slug`, QR-код, экран «Лиды» с бейджами, транскриптом и фильтром junk.
