...
- [x] Полноценный редактор квиза (`/editor?id=`): редактирование обложки,
  вопросов и вариантов прямо на холсте, добавление/удаление/перетаскивание
  шагов и вариантов, форма контактов и бонус, акцент и фон; «Сохранить»
  создаёт квиз с нуля (без id) или обновляет; публикация/снятие; всё
  сразу отражается в публичном квизе `/q/[slug]`
